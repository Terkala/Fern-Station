    ...
    private void UpdateBodyPartHighlight()
    {
        ...
        if (_selectedBodyPart.HasValue)
        {
            ...
            try
            {
                ...
                // Red tint - using stronger red values to ensure it appears red even if texture has green tint
                // R=255 (full red), G=100 (low green), B=100 (low blue), A=220 (semi-transparent)
                _spriteSystem.LayerSetColor((spriteEntity, sprite), layerIndex, new Color(255, 100, 100, 220));
